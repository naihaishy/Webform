...
class SF_Customers_List extends WP_List_Table {

	/** Class constructor */
	public function __construct() {

		parent::__construct( array(
			'singular' => __( 'staff', 'hustca' ), //singular name of the listed records
			'plural'   => __( 'staffs', 'hustca' ), //plural name of the listed records
...
if(current_user_can('manage_options')){
			$wpdb->delete(
					"hustca_staff",	array( 'ID' =>  $id ), array( '%d' )
				);
	...
	public static function record_count() {
		...
		$sql = "SELECT COUNT(*) FROM hustca_staff";
	...
	function get_columns() {
		$columns = array(
			...
			'tel'    => __( '手机号码', 'hustca' ),
			'email' =>__( '邮箱', 'hustca' ),
			'groups' =>__( '申请部门', 'hustca' ),
			'major' =>__( '专业', 'hustca' ),
			'applytime' =>__( '报名日期', 'hustca' ),
			'apartment' =>__( '公寓', 'hustca' ),
			'building' =>__( '楼栋', 'hustca' ),
			'room' =>__( '室', 'hustca' )
		);
	...
	public function get_sortable_columns() {
		$sortable_columns = array(
			...
			'apartment' => array( 'apartment', false ),
			'building' => array( 'building', true )
		);
	...
	public function delete_message_success_ifo(){
			...
			$out='';
			$out .='<div class="notice notice-success is-dismissible"><p>成功删除!</p><br/><p><a href="http://www.hustca.com/news/wp-admin/admin.php?page=hustca_staff">返回表单页面</a></p></div>';
	...
	public function delete_message_no_perssion_ifo(){
			...
			$outl .='<div class="notice is-dismissible"><p><a href="http://www.hustca.com/news/wp-admin/admin.php?page=hustca_staff">返回表单页面</a></p></div>';
	...
	public function process_bulk_action() {
		...
		if ( 'delete' === $this->current_action() ) {
		    ...
		    // wp_redirect( esc_url_raw(add_query_arg(array('page' => 'hustca_staff'), 'http://www.hustca.com/news/wp-admin/admin.php')) );
				exit;
			}
...
class SF_SP_Plugin {
	...
	public function screen_option() {
		...
		$this->customers_obj = new SF_Customers_List();
	}
